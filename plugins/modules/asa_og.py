...
from ansible.module_utils.network.asa.argspec.og.og import OGArgs
from ansible.module_utils.network.asa.config.og.og import OG
...
def main():
    ...
    module = AnsibleModule(argument_spec=OGArgs.argument_spec,
                           required_if=required_if,
                           mutually_exclusive=mutually_exclusive,
                           supports_check_mode=True)

    result = OG(module).execute_module()
