        ...
        for name, entry in iteritems(want):
            ...
            if entry != h_item and name != "object_type":
                ...
                if entry.get("group_object"):
                    ...
                    self._add_group_object_cmd({"group_object": []}, h_item)
                if entry.get(protocol_obj) and entry[protocol_obj].get("protocol"):
                    self._compare_object_diff(
                        entry,
                        h_item,
                        protocol_obj,
        ...
        for name, entry in iteritems(want):
            ...
            if entry != h_item and name != "object_type":
                ...
                if entry.get("group_object"):
                    ...
                    self._add_group_object_cmd({"group_object": []}, h_item)
                if entry.get(security_obj) and entry[security_obj].get("sec_name"):
                    self._compare_object_diff(
                        entry,
                        h_item,
                        security_obj,
                ...
                elif h_item and h_item.get(security_obj) and h_item[security_obj].get("sec_name"):
                    h_item[security_obj] = {
                        "sec_name": h_item[security_obj].get("sec_name"),
                    }
                if entry.get(security_obj) and entry[security_obj].get("tag"):
                    self._compare_object_diff(
                        entry,
                        h_item,
                        security_obj,
                ...
                elif h_item and h_item.get(security_obj) and h_item[security_obj].get("tag"):
                    h_item[security_obj] = {
        ...
        for name, entry in iteritems(want):
            ...
            if entry != h_item and name != "object_type":
                ...
                if entry.get("group_object"):
                    ...
                    self._add_group_object_cmd({"group_object": []}, h_item)
                if entry.get(user_obj) and entry[user_obj].get("user"):
                    self._compare_object_diff(
                        entry,
                        h_item,
                        user_obj,
                ...
                elif h_item and h_item.get(user_obj) and h_item[user_obj].get("user"):
                    h_item[user_obj] = {"user": h_item[user_obj].get("user")}
                    self.compare(parsers, {}, h_item)
                if entry.get(user_obj) and entry[user_obj].get("user_group"):
                    self._compare_object_diff(
                        entry,
                        h_item,
                        user_obj,
                ...
                elif h_item and h_item.get(user_obj) and h_item[user_obj].get("user_group"):
                    h_item[user_obj] = {
